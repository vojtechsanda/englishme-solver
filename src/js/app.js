        ...
        const markup = `
            <section class="js-em-solver em-solver">
                ...
                <header class="em-solver__header">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="32" height="32" viewBox="0 0 32 32" class="em-solver__icon">
                        <title>Close</title>
                ...
                <main class="em-solver__main">
                    <div class="em-solver__errors-wrapper">
                        <p class="em-solver__error">Unable to analyze the task type</p>
                    </div>
                    <div class="em-solver__btns-wrapper">
                        <button class="em-solver__btn">Solve!</button>
                        <button class="em-solver__btn">Fill current task</button>
                    </div>
                </main>
                <footer class="em-solver__footer">
                    <div class="em-solver__author-wrapper">
                        <a href="https://github.com" target="_blank" class="em-solver__link-block">
